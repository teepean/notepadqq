...
namespace EditorNS
{
    ...
    public:
        ...
        /**
         * @brief Prevent QWebEngine from freezing the page when the view is hidden.
         *        Qt 6 changes the lifecycle state of hidden QWebEngineViews, which
         *        can crash pending V8 work.
         */
        void setWebPageLifecycleActive();
